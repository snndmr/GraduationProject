...
train = pd.read_csv("datasets/cnc.csv")
test = pd.read_csv("datasets/cnc_tesst.csv")
df = train.append(test).reset_index()


df = pd.read_csv("datasets/cnc.csv")
...
train_df.to_pickle("datasets/liftUp_cnc/prepared_data/train_df.pkl")
test_df.to_pickle("datasets/liftUp_cnc/prepared_data/test_df.pkl")
